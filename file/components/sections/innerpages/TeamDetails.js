...
const TeamDetails = () => {
  return (
              ...
              <div className="team-details__bottom-right">
                <div className="team-details__progress">
                  <div className="team-details__progress-single">
                    ...
                    <div className="bar">
                      <div className="bar-inner count-bar" data-percent="90%" style={{ width: `77%` }}>
                  ...
                  <div className="team-details__progress-single">
                    ...
                    <div className="bar">
                      <div className="bar-inner count-bar" data-percent="80%" style={{ width: `77%` }}>
                  ...
                  <div className="team-details__progress-single">
                    ...
                    <div className="bar marb-0">
                      <div className="bar-inner count-bar" data-percent="75%" style={{ width: `77%` }}>
    ...
    <section className="team-contact-form">
      <div className="container pb-100">
        <div className="sec-title text-center"> <span className="sub-title">Contact With Us Now</span>
          ...
          <div className="col-lg-8"> 
            ...
            <form id="contact_form" name="contact_form" action="#" method="post">
              ...
              <div className="mb-3 text-center">
                ...
                <button type="submit" className="theme-btn btn-style-one mb-3 mb-sm-0 me-2" data-loading-text="Please wait..."><span className="btn-title">Send message</span></button>
