      ...
      <footer className="main-footer footer-style-five">
        ...
        <div className="auto-container">
                      ...
                      <div className="widget-content">
                        <ul className="contact-list-four">
                          <li>
                            ...
                            <Link href="#">username@domain.com</Link>
                          </li>
                          <li>
                            <i className="icon fal fa-mobile"></i>
                            <Link href="#">+(123) 456 - 7890 - 456 - 7890</Link>
                          </li>
                          <li>
                            <i className="icon fa fa-map-marker-alt"></i>
                            <Link href="#">Street New York</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
          ...
          <div className="footer-lower">
            <Swiper
              {...swiperOptions}
              className="gallery-carousel-three owl-carousel owl-theme disable-navs"
            >
              <SwiperSlide>
                  ...
                  <div className="inner-box">
                    <div className="image-box">
                      <figure className="image">
                        <img src="images/resource/gallery4-1.jpg" alt="Image" />
                      </figure>
              ...
              <SwiperSlide>
                <div className="gallery-block-two">
                  <div className="inner-box">
                    <div className="image-box">
                      <figure className="image">
                        <img src="images/resource/gallery4-2.jpg" alt="Image" />
                      </figure>
                      <div className="overlay">
              ...
              <SwiperSlide>
                <div className="gallery-block-two">
                  <div className="inner-box">
                    <div className="image-box">
                      <figure className="image">
                        <img src="images/resource/gallery4-3.jpg" alt="Image" />
                      </figure>
                      <div className="overlay">
                        <Link href="page-gallery">
                          <i className="icon fa fa-expand"></i>
              ...
              <SwiperSlide>
                <div className="gallery-block-two">
                  <div className="inner-box">
                    <div className="image-box">
                      <figure className="image">
                        <img src="images/resource/gallery4-4.jpg" alt="Image" />
                      </figure>
                      <div className="overlay">
                        <Link href="page-gallery">
                          <i className="icon fa fa-expand"></i>
              ...
              <SwiperSlide>
                <div className="gallery-block-two">
                  <div className="inner-box">
                    <div className="image-box">
                      <figure className="image">
                        <img src="images/resource/gallery4-5.jpg" alt="Image" />
                      </figure>
                      <div className="overlay">
                        <Link href="page-gallery">
                          <i className="icon fa fa-expand"></i>
              ...
              <SwiperSlide>
                <div className="gallery-block-two">
                  <div className="inner-box">
                    <div className="image-box">
                      <figure className="image">
                        <img src="images/resource/gallery4-6.jpg" alt="Image" />
                      </figure>
                      <div className="overlay">
                        <Link href="page-gallery">
                          <i className="icon fa fa-expand"></i>
        ...
        <div className="footer-bottom">
          <div className="auto-container">
            <div className="copyright-text">
              Copyright © Ranula Gamage . All rights reserved.
            </div>
          </div>
        </div>
      </footer>
