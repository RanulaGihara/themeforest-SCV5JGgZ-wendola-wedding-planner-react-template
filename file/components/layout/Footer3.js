              ...
              <div className="footer-column col-xl-4 col-lg-6 col-md-6 col-sm-12">
                <div className="footer-widget about-widget">
                  <div className="widget-content">
                    <div className="logo">
                      <Link href="/">
                        <img src="/images/logo.png" alt="" title="Wendola" />
                      </Link>
                    </div>
                    <div className="text">
                      Semper libero, sit amet blandit vel, rhoncus <br /> ven
                      enatis luctus pulvinar, hendrerit id, lore <br /> m. Semp
                      er libero, sit amet blandit vel.
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="footer-widget contact-widget">
                  ...
                  <div className="widget-content">
                    <ul className="contact-list-three light">
                      ...
                      <li>
                        <i className="icon far fa-mobile"></i>
